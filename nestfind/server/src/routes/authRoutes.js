...
router.post('/verify-email', otpLimiter, validateOTP, authController.verifyEmail);
router.post('/send-otp', otpLimiter, authController.sendOTP);
router.post('/verify-otp', otpLimiter, validateOTP, authController.verifyOTP);
router.post('/resend-otp', otpLimiter, validateResendOTP, authController.sendOTP);
...
// Preferences
router.patch('/notification-preferences', validateNotificationPreferences, authController.updateNotificationPreferences);
router.patch('/ai-preferences', validateAIPreferences, authController.updateAIPreferences);
